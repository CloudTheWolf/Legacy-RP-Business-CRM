...
class LivewireSelect extends Component
{
    ...
    public function mount($name,
                          ...
                          $selectView = 'livewire-select::select.select',
                          $defaultView = 'livewire-select::select.default',
                          $searchView = 'livewire-select::select.search',
                          $searchInputView = 'livewire-select::select.search-input',
                          $searchOptionsContainer = 'livewire-select::select.search-options-container',
                          $searchOptionItem = 'livewire-select::select.search-option-item',
                          $searchSelectedOptionView = 'livewire-select::select.search-selected-option',
                          $searchNoResultsView = 'livewire-select::select.search-no-results',
                          $extras = [])
    {
        $this->name = $name;
    ...
    public function styles()
    {
        return [
            ...
            'search' => 'relative',
            'searchInput' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500',
