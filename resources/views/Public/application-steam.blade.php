    ...
    <div class="sw-lg-80 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
        <div class="sw-lg-50 px-5">
            ...
            <div>
                ...
                @endif
                <a href="{{route("apply.auth.steam")}}" class="btn btn-lg btn-outline-info" style="width: 100% !important;"><i class="lni lni-steam"></i> Link Your Steam Profile</a>
                <hr>
                <form method="post">
                    @csrf
                    <input type="hidden" id="steamId" name="steamId" value="0">
                    <button type="submit" class="btn btn-lg btn-info" style="width: 100% !important;">Skip</button>
                </form>
            </div>
        </div>
    </div>
